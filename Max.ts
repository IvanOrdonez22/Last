...
class MaxHeapEmergency {
    ...
    public showPatients(): void {
        for (let i = 1; i <= this.n; i++) {
            ...
            console.log(`${patient.getName()} - Priority: ${patient.getPriority()} - Phone: ${patient.getPhone()}`);
        }
    }
...
let emergencyRoom = new MaxHeapEmergency(5);
...
console.log("")
console.log("El paciente con mayor prioridad se ha ido: ", emergencyRoom.getMax().getName())
console.log("")
console.log("Actualizando la prioridad de Carlos a 9:");
emergencyRoom.updatePriority("Carlos", 9);
console.log("")
